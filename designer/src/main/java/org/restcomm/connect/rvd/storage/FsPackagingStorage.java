...
public class FsPackagingStorage {
    ...
    public static Rapp loadRapp(String projectName, OldWorkspaceStorage storage) throws StorageException {
    ...
    public static void storeRapp(Rapp rapp, String projectName, OldWorkspaceStorage storage) throws StorageException {
    ...
    public static void storeRappBinary(File sourceFile, String projectName, OldWorkspaceStorage storage ) throws RvdException {
    ...
    public static InputStream getRappBinary(String projectName, OldWorkspaceStorage storage) throws AppPackageDoesNotExist {
        try {
    ...
    public static boolean hasPackaging(String projectName, OldWorkspaceStorage storage) throws ProjectDoesNotExist {
    ...
    public static boolean binaryAvailable(String projectName, OldWorkspaceStorage storage) {
